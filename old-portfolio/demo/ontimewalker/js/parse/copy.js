...
// [JŽr™me Gravel-Niquet](http://jgn.me/). This demo uses Parse to persist
	...
	var ManageTodosView = Parse.View.extend({
		...
		initialize : function() {
			...
			_.bindAll(this, 'addOne', 'addAll', 'addSome', 'render',
					'toggleAllComplete', 'logOut', 'createOnEnter');
			...
			// Setup the query for the collection to look for todos from the
			// current user
